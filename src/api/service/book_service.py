...
class BookService():
    ...
    def get_all_books(self, page: int = 1, page_size:int = 10):
    ...
    def get_all_books_most_rated(self, page: int = 1, page_size: int = 10):
    ...
    def get_books_from_title_or_category(self, title, category):
